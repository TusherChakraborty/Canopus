...
public class Poly2TriUtils {
	...
	public static String typeToString(int type){
		switch (type){
		case Poly2TriUtils.UNKNOWN:        return "UNKNOWN";
		case Poly2TriUtils.INPUT:        return "INPUT";
		case Poly2TriUtils.INSERT:        return "INERT";
		case Poly2TriUtils.START:        return "START";       
		case Poly2TriUtils.END:          return "END";         
		case Poly2TriUtils.MERGE:        return "MERGE";       
		case Poly2TriUtils.SPLIT:        return "SPLIT";       
		case Poly2TriUtils.REGULAR_UP:   return "REGULAR_UP";  
		case Poly2TriUtils.REGULAR_DOWN: return "REGULAR_DOWN";
		default: 						 return "??? ("+type+")";
		}
	}
